...
Projeto elaborado  para solucionar [esse desafio](https://github.com/PicPay/picpay-desafio-backend?tab=readme-ov-file) para uma vaga backend com . A solução desenvolvida é basicamente uma versão simplificada do PicPay desafio [original](https://github.com/PicPay/picpay-desafio-backend).
